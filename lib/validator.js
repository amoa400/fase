...
var rIp = require('./rules/ip.js');
var rRegExp = require('./rules/regexp.js');
 ...
 */
Validator.prototype.config = function(opt) {
	this.opt = opt;
}
...
Validator.prototype.createDefaultRules = function() {
	...
	this.createRule(rIp.name, rIp.func);
	this.createRule(rRegExp.name, rRegExp.func);
};
